export default {
    ...
    resizeLabelFormCaption: "Dimensioni dell'immagine di output",

    resizeLabelInputWidth: 'l',
    resizeTitleInputWidth: 'Larghezza',
    resizeLabelInputHeight: 'a',
    resizeTitleInputHeight: 'Altezza',
