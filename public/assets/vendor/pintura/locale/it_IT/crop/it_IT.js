export default {
    ...
    cropLabelButtonRecenter: 'Ricentra',
    cropLabelButtonRotateLeft: 'Ruota a sinistra',
    cropLabelButtonRotateRight: 'Ruota a destra',
    cropLabelButtonFlipHorizontal: 'Capovolgi orizzontalmente',
    cropLabelButtonFlipVertical: 'Capovolgi verticalmente',

    cropLabelSelectPreset: 'Forma ritaglio',

    cropLabelCropBoundary: 'Bordo del ritaglio',
    cropLabelCropBoundaryEdge: "Bordo dell'immagine",
    cropLabelCropBoundaryNone: 'Nessuno',

    cropLabelTabRotation: 'Rotazione',
    cropLabelTabZoom: 'Scala',
};
