export default {
    ...
    cropLabelButtonRecenter: 'Centrera om',
    cropLabelButtonRotateLeft: 'Rotera åt vänster',
    cropLabelButtonRotateRight: 'Rotera åt höger',
    cropLabelButtonFlipHorizontal: 'Vänd horisontellt',
    cropLabelButtonFlipVertical: 'Vänd vertikalt',

    cropLabelSelectPreset: 'Beskärningsform',

    cropLabelCropBoundary: 'Beskärningsgräns',
    cropLabelCropBoundaryEdge: 'Bildkant',
