export default {
    ...
    cropLabelButtonRecenter: 'Centreren',
    cropLabelButtonRotateLeft: 'Roteer linksom',
    cropLabelButtonRotateRight: 'Roteer rechtsom',
    cropLabelButtonFlipHorizontal: 'Spiegel horizontaal',
    cropLabelButtonFlipVertical: 'Spiegel verticaal',

    cropLabelSelectPreset: 'Kies bijsnijdvorm',

    cropLabelCropBoundary: 'Bijsnijd grens',
    cropLabelCropBoundaryEdge: 'Rand van afbeelding',
    cropLabelCropBoundaryNone: 'Geen',

    cropLabelTabRotation: 'Rotatie',
    cropLabelTabZoom: 'Schalen',
};
