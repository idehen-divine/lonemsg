export default {
    ...
    cropLabelButtonRecenter: 'फिर से केंद्रित करें',
    cropLabelButtonRotateLeft: 'बाएं ओर घुमाएं',
    cropLabelButtonRotateRight: 'दाएं ओर घुमाएं',
    cropLabelButtonFlipHorizontal: 'क्षैतिज फ्लिप करें',
    cropLabelButtonFlipVertical: 'ऊर्ध्वाधर फ्लिप करें',

    cropLabelSelectPreset: 'क्रॉप आकार',

    cropLabelCropBoundary: 'क्रॉप सीमा',
    cropLabelCropBoundaryEdge: 'छवि की सीमा',
    cropLabelCropBoundaryNone: 'कोई नहीं',

    cropLabelTabRotation: 'घुमाव',
    cropLabelTabZoom: 'स्केल',
};
