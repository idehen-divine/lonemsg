export default {
    ...
    cropLabelButtonRotateLeft: 'Rodar para a esquerda',
    cropLabelButtonRotateRight: 'Rodar para a direita',
    cropLabelButtonFlipHorizontal: 'Inverter horizontalmente',
    cropLabelButtonFlipVertical: 'Inverter verticalmente',

    cropLabelSelectPreset: 'Formato do corte',

    cropLabelCropBoundary: 'Limites do corte',
    cropLabelCropBoundaryEdge: 'Borda da imagem',
    cropLabelCropBoundaryNone: 'Nenhum',

    cropLabelTabRotation: 'Rotação',
    cropLabelTabZoom: 'Escala',
};
