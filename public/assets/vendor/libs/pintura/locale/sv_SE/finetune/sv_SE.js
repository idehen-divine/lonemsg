export default {
    ...
    finetuneLabelBrightness: 'Ljusstyrka',
    finetuneLabelContrast: 'Kontrast',
    finetuneLabelSaturation: 'Mättnad',
    finetuneLabelExposure: 'Exponering',
    finetuneLabelTemperature: 'Temperatur',
    finetuneLabelGamma: 'Gamma',
    finetuneLabelClarity: 'Tydlighet',
    finetuneLabelVignette: 'Vignett',
};
